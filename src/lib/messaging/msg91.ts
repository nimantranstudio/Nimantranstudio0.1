...
// Must match the template's language on the MSG91 dashboard exactly. The
// welcome_nimantran template is approved under 'en'.
const WA_LANG = process.env.MSG91_WA_LANG || 'en';

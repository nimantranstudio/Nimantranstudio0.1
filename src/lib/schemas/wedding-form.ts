...
export const DEFAULT_EVENTS: WeddingEvent[] = [
    ...
    { id: 'wedding', name: 'Wedding', date: '', time: '', endTime: '', venue: '', description: 'The moment we\'ve dreamed of is finally here! Join us as two hearts become one and we begin our forever, surrounded by the love of family & friends.', tagline: 'We are pleased to invite you to the wedding of', heading: 'Wedding', isCustomVenue: false },

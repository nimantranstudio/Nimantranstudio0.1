...
export const DEFAULT_EVENTS: WeddingEvent[] = [
    { id: 'haldi', name: 'Haldi', date: '', time: '', endTime: '', venue: '', description: 'Come glow with us! Smear on the golden turmeric, soak in the laughter, and shower the couple with blessings as our wedding journey begins!', tagline: 'Bless the couple with showers of yellow health and happiness', heading: 'Haldi Ceremony', isCustomVenue: false },
    { id: 'mehendi', name: 'Mehendi', date: '', time: '', endTime: '', venue: '', description: 'Hands full of mehendi, hearts full of love! Join us for an afternoon of intricate art, sweet sounds, and laughter as we color the day with joy.', tagline: 'Join at the mehendi event, with the "Hands full of mehendi , hearts full of love"', heading: 'Mehendi Ceremony', isCustomVenue: false },
    { id: 'sangeet', name: 'Sangeet', date: '', time: '', endTime: '', venue: '', description: 'Naach, gaana aur full-on hungama! Put on your dancing shoes and join us for a magical night of music, masti, and memories on the dance floor!', tagline: 'Join us to turn up the volume "Naach. gaana aur full-on hungama!"', heading: 'Sangeet Ceremoney', isCustomVenue: false },
    { id: 'wedding', name: 'Wedding', date: '', time: '', endTime: '', venue: '', description: 'The moment we\'ve dreamed of is finally here! Join us as two hearts become one and we begin our forever, surrounded by the love of family & friends.', tagline: 'We are pleased to invite you to the wedding of', heading: 'Wedding Ceremony', isCustomVenue: false },
    { id: 'reception', name: 'Reception', date: '', time: '', endTime: '', venue: '', description: 'Raise a toast with us! Join the celebration for an evening of love, laughter, delicious food, and dancing as we make memories to cherish forever.', tagline: 'We are pleased to invite you to the reception of', heading: 'Reception Ceremony', isCustomVenue: false },
];

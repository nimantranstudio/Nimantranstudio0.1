                ...
                <div className={styles.footerGrid}>
                    ...
                    <div className={styles.brandCol}>
                        ...
                        <div className={styles.socials}>
                            ...
                            <a href="https://www.instagram.com/nimantranstudio.in/" aria-label="Instagram" target="_blank" rel="noopener noreferrer">
                                <div className={styles.socialIcon}><InstagramIcon size={18} /></div>
                            </a>
                            <a href="https://www.youtube.com/@nimantranstudio" aria-label="YouTube" target="_blank" rel="noopener noreferrer">
                                <div className={styles.socialIcon}><YoutubeIcon size={18} /></div>
                            </a>
                            <a href="https://in.pinterest.com/nimantranstudioin" aria-label="Pinterest" target="_blank" rel="noopener noreferrer">
                    ...
                    <div className={styles.linkCol}>
                        ...
                        <ul className={styles.contactList}>
                            ...
                            <li>
                                ...
                                <a href="tel:+918010581916">+91 80105 81916</a>
                            </li>
                            <li>
